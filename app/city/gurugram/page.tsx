    ...
    <main className="min-h-screen bg-white text-black">
      ...
      <div className="relative bg-zinc-800 w-full h-[400px]">
        ...
        <div className="relative h-[500px] flex items-center justify-center z-10">
          <div className="container mx-auto px-4">
            <h1 className="text-3xl font-bold text-white text-center">Rental Scaffolding or Shuttering Materials in Gurugram</h1>
          </div>
        </div>
      </div>
      ...
      <div className="p-8 max-w-6xl mx-auto">
        ...
        <section className="mt-8 space-y-6">
          ...
          {[
            ["Adjustable Telescopic Prop on Rent/Hire", "Adjustable Telescopic Prop is a versatile scaffolding material to hire that support tool widely used in construction to temporarily hold up beams, slabs, and other horizontal structures. The prop consists of two steel tubes, with one sliding inside the other, allowing for height adjustments to meet the specific requirements of various construction projects. For those in need of reliable support equipment, Adjustable Telescopic Props on rent or hire in Gurugram offer a cost-effective solution, ensuring flexibility and stability across various building sites."],
            ["Cuplock System on Rent/Hire", "The Cuplock System is a flexible and fairly green scaffolding material widely utilized in creation due to its ease of meeting, strength, and versatility. It's designed to aid heavy hundreds and is ideal for an extensive range of tasks, from small residential jobs to massive-scale industrial and industrial production. For those in need of reliable support equipment, the Cuplock System on rent or hire in Gurugram offers a cost-effective solution, ensuring flexibility across various building sites."],
            ["Acro Spans on Rent/Hire", "Acro Spans, also referred to as Adjustable Spans, are specialized scaffolding components designed to provide a brief guide for slabs, beams, and ceilings for the duration of production. Their strong production and adjustable features make them perfect for ensuring the stability of horizontal systems until everlasting help is in location. For those in need of reliable support equipment, Acro Spans on rent or hire in Gurugram offers a cost-effective solution, ensuring stability across various building sites."],
            ["Adjustable Base Jacks on Rent/Hire", "Adjustable Base Jacks are crucial materials in scaffolding structures, designed to provide a solid base for scaffolding structures. These jacks are important for ensuring precise levelling and height adjustments, in particular when working on uneven or sloping surfaces. Their capability to keep balance and stability complements each the protection and performance of production projects. For those in need of reliable support equipment, Adjustable Base Jacks on rent or hire in Gurugram offer a cost-effective solution, ensuring stability across various building sites."],
            ["MS Shuttering Plates on Rent/Hire", "MS Shuttering Plates are integral components used in the construction of formwork systems for concrete structures. They are essential for shaping and supporting concrete while it sets and hardens. For those in need of reliable support equipment, MS Shuttering Plates on rent or hire in Gurugram offer a cost-effective solution, ensuring stability across various building sites."],
            ["Steel Challi on Rent/Hire", "Steel Challi is a vital component used in scaffolding and construction for providing reliable support for vertical loads. Also known as Steel Props or Vertical Supports, Steel Challis are designed to handle significant weight and stress, ensuring the stability and safety of scaffolding structures and other temporary supports. For those in need of reliable support equipment, Steel Challi on rent or hire in Gurugram offers a cost-effective solution, ensuring stability across various building sites."],
            ["Vertical Standards on Rent/Hire", "Vertical Standards, additionally known as Vertical Posts or Vertical Tubes, are critical components in scaffolding structures. They are accountable for transferring the masses from the scaffold shape down to the ground, presenting vital stability and support. For those in need of reliable support equipment, Vertical Standards on rent or hire in Gurugram offers a cost-effective solution, ensuring stability across various building sites."],
            ["Horizontal Ledgers on Rent/Hire", "Horizontal Ledgers are important components in scaffolding structures, offering vital horizontal support and bracing. They play a key role in preserving the stability and protection of the scaffold structure. For those in need of reliable support equipment, Horizontal Ledgers on rent or hire in Gurugram offer a cost-effective solution, ensuring stability across various building sites."],
            ["Pop Jack Teka on Rent/Hire", "Looking to rent Pop Jack Teka in Gurugram? Pop Jack Teka is a versatile and essential scaffolding tool to rent for construction projects in Gurugram, ensuring stability and safety during formwork and scaffolding tasks. Renting Prop Jack Teka from trusted providers like ABS SCAFFOLDING SOLUTIONS offers a cost-effective and reliable solution tailored to your specific project needs. Known for their commitment to quality and safety, ABS SCAFFOLDING SOLUTIONS provides sturdy, adjustable equipment that adheres to industry standards, ensuring efficient and secure construction processes. For more details, visit ABS SCAFFOLDING SOLUTIONS."],
            ["Spigot Pins on Rent/Hire", "Spigot Pins are important additives in scaffolding structures used to connect and steady vertical scaffolding tubes, ensuring the structural integrity and balance of the scaffold. They play a key role in assembling and maintaining the electricity of the scaffolding shape. For those in need of reliable support equipment, Spigot Pins on rent or hire in Gurugram offers a cost-effective solution, ensuring stability across various building sites."],
            ["U Head Jack on Rent/Hire", "A U Head Jack or Adjustable U Jack for scaffolding is an adjustable support used to secure and stabilize beams or formwork in construction. Its U-shaped head holds horizontal structures in place, preventing movement. The jack's adjustable height provides flexibility, while its robust steel design ensures strong load-bearing capacity, making it essential for stable and secure scaffolding setups. For those in need of reliable support equipment, Adjustable U Jack/U Head Jack on rent or hire in Gurugram offers a cost-effective solution, ensuring stability across various building sites."]
          ].map(([title, desc], idx) => (
            <div key={idx}>
